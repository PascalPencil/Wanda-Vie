...
<head>
  ...
  <style>
    ...
    .form-control {background: rgba(0, 0, 0, 0.3);border-color: rgb(102, 102, 102);}
  </style>
</head>
<body>
  <div id="fb-root"></div>
  <script>(function(d, s, id) {
    ...
    js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=312889068852708&version=v2.0";
